<template>
	...
	<main class="main">
		<h1 class="heading">Rebuilding Text</h1>
		<p>
        ...
        <ul>
            ...
            <li>repetitions: the amount of repetitions the rebuilding text component will get rebuilt. Defaults to one
                repetition.</li>
...
import RebuildingTextComponent from "../../../modules/vue-components/rebuilding-text/RebuildingText.vue";
</script>
