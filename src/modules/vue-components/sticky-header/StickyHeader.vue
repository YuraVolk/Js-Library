...
import { ref, onMounted, onUnmounted, reactive, CSSProperties, nextTick } from "vue";
import { generateThreshold } from "src/modules/interfaces/generic/intersectionObserved";
import { StickyHeaderMinimalConfiguration } from "src/modules/interfaces/component/sticky-header/types";
