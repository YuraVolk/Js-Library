<template>
  ...
  <main class="main">
    ...
    <ul>
      ...
      <li>
        separationMultiplier, a number that defines the multiplier for separation via images from center.
        Defaults to 0.6.
      </li>
      <li>horizonOffset, a number that sets the offset to the carousel horizon. Defaults to 0.</li>
      <li>
        horizonOffsetMultiplier, a number that sets the multiplier on flanking items for the horizon constant.
        Defaults to 1.
      </li>
      <li>sizeMultiplier, a number that sets the scaling for the more distant images. Defaults to 0.7.</li>
      <li>
        opacityMultiplier, a number that sets the opacity multiplier for the more distant images. Defaults to
        0.87.
      </li>
      <li>horizon, a number that sets the horizon constant (main axis), defaults to 0.</li>
      <li>
        flankingItems, a number that sets how many items are visible to left or right from the central item.
        Defaults to 3.
      </li>
