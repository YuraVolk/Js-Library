<template>
  ...
  <main class="main">
    ...
    <ul>
      <li>
        smoothDiametralTransition: Determines whether the transition between the last item and the
        first item is smooth. By default, this property is set to true.
      </li>
      ...
      <li>
        showArrows: Determines whether the arrows for navigating to the previous or next item are
