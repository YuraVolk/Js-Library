  ...
  <main class="main">
    ...
    >
      <table class="table">
        <thead class="table-head">
          <tr>
            <table-filtering-header-component
              ...
              @click="() => onHeaderClicked(0)"
            >
              Name
            </table-filtering-header-component>
            <table-filtering-header-component
              class="table-head__heading"
              @click="() => onHeaderClicked(1)"
            >
              Country
            </table-filtering-header-component>
            <table-filtering-header-component
              class="table-head__heading"
              @click="() => onHeaderClicked(2)"
            >
              Specialty
            </table-filtering-header-component>
          </tr>
        ...
        <tbody
          class="table-body"
          @click="onTableBodyClicked"
        >
          <table-filtering-row-component class="table-body-row">
            <td class="table-body-row__cell">
              John
            </td>
            <td class="table-body-row__cell">
              Austria
...
import TableFilteringComponent from "../../../components/table-filtering/TableFiltering.vue";
