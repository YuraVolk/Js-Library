	...
	return (
		<main className="main">
			...
			<p>
				...
				settings with your own settings and give the design you like. This approach requires a custom React-implemented behavior, and as such
				this component provides the basics to work with, as it automatically configures the vital video settings, like pausing and playing,
				muting, changing volume, resetting video, changing current video time, and overall smooth animations.
			</p>
			<p>
