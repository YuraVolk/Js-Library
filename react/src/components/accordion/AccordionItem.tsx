...
export const AccordionItem = (props: AccordionListItemConfiguration) => {
	...
	const updateHeight = useCallback(() => {
		...
		const isExpanded = typeof context.expandedIndex === "string" ? context.expandedIndex === id : context.expandedIndex.includes(id);
	...
	return (
		<li className={styles.accordion} style={{ maxHeight }}>
