			...
			${this.openSelect?W`<div
				  ...
				  >
						${this.openSelect.options.map((t=>($t(this.openSelect),W`<div
								class="wrap-select__option ${Qt({"wrap-select__option--crossed":this.tabularData.excludedCriteria[this.openSelect?.index??0].includes(t)})}"
